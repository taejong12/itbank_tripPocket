...
<div class="container">
    ...
    <form action="${contextPath}/share/updateContents.do" method="post">
        <!-- 여행 후기 입력 폼 -->
                ...
                <div class="trip-day" id="trip-day-${i}">
                    ...
                    <c:forEach var="day" items="${detailList}">
                        <c:if test="${day.tripShareDayDay == i}">
                            ...
                            <textarea name="dayContents" id="review-${day.tripDayId}" class="review-text" rows="4">${day.tripShareContent}</textarea>
                        </c:if>
                    </c:forEach>
                </div>
            </c:if>
        ...
        <div style="margin-top: 20px;">
            <button type="submit">후기 저장하기</button>
        </div>
    </form>
